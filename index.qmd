...
df |> 
  likert_plot(x = q19, y = group, symmetric = T,
              subtitle = "How confident are you that votes in Maricopa County, AZ will be counted as voters intend in the elections this November?",
              caption = "VMF Recruitment = 639, Standard Recruitment = 624")


# same plot, without the function
# df |>
#   ggstats::gglikert(include = c(q19), y = 'group', symmetric = T)+
#   ggplot2::facet_grid(cols = vars(.question))+
#   ggplot2::geom_vline(xintercept = 0, color = 'black', linewidth = 1.5)+
#   ggplot2::labs(
...
#   )+
#   ggplot2::theme_bw()+
#   ggplot2::theme(legend.position = 'bottom',    # place legend on bottom
#         axis.text.x = element_blank(), # remove percentage text along x-axis
...
df |> 
  ...
  labs(
    ...
    caption = "VMF Recruitment = 634, Standard Recruitment = 624",
...
df |> 
  likert_plot(
    ...
    y = group,
    symmetric = T,
    subtitle = "How confident are you that the voting process will be fair in Maricopa County, AZ?",
    caption = "VMF Recruitment = 639, Standard Recruitment = 624")
...
df |>
  ggstats::gglikert(include = c(q23), y = 'group', symmetric = T)+
  ggplot2::facet_grid(cols = vars(.question))+
  labs(
    caption = "VMF Recruitment = 639, Standard Recruitment = 624",
...
df |>
  ...
  ggstats::gglikert(include = c(q25), y = 'group', symmetric = T)+
  ggplot2::facet_grid(cols = vars(.question))+
  labs(
    caption = "VMF Recruitment = 639, Standard Recruitment = 623",
...
df |>
  ...
  ggstats::gglikert(include = c(q26), y = 'group', symmetric = T)+
  ggplot2::facet_grid(cols = vars(.question))+
  labs(
    caption = "VMF Recruitment = 639, Standard Recruitment = 623",
...
df |> 
  ...
  labs(
    ...
    caption = 'VMF Recruitment = 638, Standard Recruitment = 623'
  )+
  theme_bw()+
  theme(legend.position = 'bottom',
        axis.text.x = element_blank(),
