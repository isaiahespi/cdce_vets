...
df |> 
  ...
  labs(
    subtitle = "How would the following impact your confidence in the fairness and accuracy of elections conducted this November?"
  )+
  theme_bw()+
...
df |> 
  ...
  labs(
    ...
    subtitle = "How would the following impact your confidence that voters are safe from violence, threats of violence, or intimidation while voting in-person during elections this November?"
  )+
  theme_bw()+
  theme(legend.position = 'bottom', legend.key.size = unit(0.3, "cm"),
        legend.text = element_text(size = 8.5))
