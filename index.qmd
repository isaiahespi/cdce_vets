...
#| fig-cap: "Confidence in Accurate Vote Count by Recruitment Program"
...
#| fig-cap: "Confidence in Commitment of Election Staff and Volunteers by Recruitment Program"
#| fig-cap-location: top
...
df |>
  ...
  ggplot2::facet_grid(cols = vars(.question))+
  labs(
    title = "Confidence in Commitment of Election Staff and Volunteers by Recruitment Program",
    caption = "VMF Recruitment = 639, Standard Recruitment = 624",
...
#| fig-cap: "Confidence in Fair Voting Process by Recruitment Program"
#| fig-cap-location: top
...
df |>
  ...
  ggplot2::facet_grid(cols = vars(.question))+
  labs(
    title = "Confidence in Fair Voting Process by Recruitment Program",
    caption = "VMF Recruitment = 639, Standard Recruitment = 624",
...
```{r}
#| label: fig-q22-legit
#| fig-cap: "Confidence in Fair Voting Process in Maricopa County, AZ among those who believe Biden's 2020 election was not legitimate"
#| fig-cap-location: top
#| column: body-outset
...
df |> 
  ...
  scale_fill_manual(values = c("black", "grey35", "firebrick1", "firebrick3"))+
  labs(
    title = "Confidence in Fair Voting Process in Maricopa County, AZ by Beliefs of 2020 Election Legitimacy and Recruitment Program",
    subtitle = "Do you think Joe Biden's election as president was legitimate, or was he not legitimately elected?",
    caption = "VMF Recruitment = 639, Standard Recruitment = 624",
    x = "How confident are you that the voting process will be fair in Maricopa County, AZ?"
  )+
...
#| fig-cap: "In-person voter safety in Maricopa County, AZ by Recruitment Program"
#| fig-cap-location: top
...
df |>
  ...
  ggplot2::facet_grid(cols = vars(.question))+
  labs(
    title ="In-person voter safety in Maricopa County, AZ by Recruitment Program",
    caption = "VMF Recruitment = 639, Standard Recruitment = 623",
    x = "How confident, if at all, are you that in person polling places in Maricopa County, AZ \nwill be safe places for voters to cast their ballots during the upcoming elections in November?"
  )+
  # customize color
  scale_fill_manual(
    values = c("black", "grey35", "firebrick1", "firebrick3")
...
```{r}
#| label: fig-20-likert
#| fig-cap: "Confidence Election Officials in Maricopa County, AZ will do a good job by Recruitment Program"
#| fig-cap-location: top

# Q20 by Recruitment program, likert plot
likert_plot(df, q20, group)+
  labs(
    title = "Confidence Election Officials in Maricopa County, AZ will do a good job by Recruitment Program",
    caption = 'VMF Recruitment =  638, Standard Recruitment = 624',
    x = str_wrap(attr(df$q20, "label"), width = 95)
  )
...
#| fig-cap: "Impact on Confidence in Election Fairness and Accuracy by Recruitment Program"
#| column: page-right
...
df |> 
  ...
  labs(
    x = str_wrap("How would the following impact your confidence in the fairness and accuracy of elections conducted this November?", width = 95)
  )+
  theme_bw()+
...
#| fig-cap: "Impact on Confidence in Voter Safety at Polling Sites by Recruitment Program"
#| column: page-right
...
df |> 
  ...
  scale_fill_manual(values = c("black", "grey20", "grey45", "firebrick1", "firebrick3")) +
  labs(
    title = "Impact on Confidence in Voter Safety at Polling Sites by Recruitment Program",
    subtitle = "Comparing increase in confidence when election staff/volunteers include veterans, lawyers, and college students",
    x = str_wrap("How would the following impact your confidence that voters are safe from violence, threats of violence, or intimidation while voting in-person during elections this November?", width = 95)
  )+
  theme_bw()+
  theme(legend.position = 'bottom', 
        legend.key.size = unit(0.3, "cm"),
