...
df |> 
  likert_plot(x = q19, y = group, symmetric = T, vline = T,
...
```{r}
#| label: fig-q19-likert-alt
#| fig-cap: "Confidence Votes will be Counted as Intended by Condition (VMF recruitment vs. Standard Recruitment)"
#| fig-cap-location: top

# alternative Likert plot with minor differences in style and look
# symmetric x-axis 
# added vertical line at center
# modified label size of percentage values
