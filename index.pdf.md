...
::: {.cell-output-display}
![Confidence in Accurate Vote Count by Recruitment Program](index_files/figure-pdf/fig-q19-likert-1.pdf){#fig-q19-likert}
:::
:::
...
::: {#fig-q19-legit .cell .fig-cap-location-top}
::: {.cell-output-display}
![Proportion of confidence in vote count by belief of Biden's election legitimacy and Experimental condition](index_files/figure-pdf/fig-q19-legit-1.pdf){#fig-q19-legit}
:::

Confidence in Vote Count by Beliefs of 2020 Election Legitimacy and Recruitment Program
:::
...
::: {.cell .fig-cap-location-top}
::: {.cell-output-display}
![Confidence in Commitment of Election Staff and Volunteers by Recruitment Program](index_files/figure-pdf/fig-q21-likert-1.pdf){#fig-q21-likert}
:::
:::
...
::: {.cell .fig-cap-location-top}
::: {.cell-output-display}
![Confidence in Fair Voting Process by Recruitment Program](index_files/figure-pdf/fig-q22-likert-1.pdf){#fig-q22-likert}
:::
:::
...
::: {.cell .column-body-outset .fig-cap-location-top}
::: {.cell-output-display}
![Confidence in Fair Voting Process in Maricopa County, AZ among those who believe Biden's 2020 election was not legitimate](index_files/figure-pdf/fig-q22-legit-1.pdf){#fig-q22-legit}
:::
:::
...
::: {.cell .fig-cap-location-top}
::: {.cell-output-display}
![Confidence in Fair Voting Outcomes by Recruitment Program](index_files/figure-pdf/fig-q23-likert-1.pdf){#fig-q23-likert}
:::
:::
...
::: {.cell .fig-cap-location-top}
::: {.cell-output-display}
![Trust in Election Systems Tech by Recruitment Program](index_files/figure-pdf/fig-q24-likert-1.pdf){#fig-q24-likert}
:::
:::
...
::: {.cell .fig-cap-location-top}
::: {.cell-output-display}
![Concern for violence, threats, or voter intimidation in Maricopa County, AZ by Recruitment Program](index_files/figure-pdf/fig-q25-likert-1.pdf){#fig-q25-likert}
:::
:::
...
::: {.cell .fig-cap-location-top}
::: {.cell-output-display}
![In-person voter safety in Maricopa County, AZ by Recruitment Program](index_files/figure-pdf/fig-q26-likert-1.pdf){#fig-q26-likert}
:::
:::
...
::: {.cell .fig-cap-location-top}
::: {.cell-output-display}
![Approval of Election Officials in Maricopa County, AZ by Recruitment Program](index_files/figure-pdf/fig-q27-likert-1.pdf){#fig-q27-likert}
:::
:::
...
::: {.cell .fig-cap-location-top}
::: {.cell-output-display}
![Confidence Election Officials in Maricopa County, AZ will do a good job by Recruitment Program](index_files/figure-pdf/fig-20-likert-1.pdf){#fig-20-likert}
:::
:::
...
::: {.cell .fig-cap-location-top}
::: {.cell-output-display}
![Approval of Election Officials in Maricopa County, AZ by Recruitment Program](index_files/figure-pdf/fig-q29-likert-1.pdf){#fig-q29-likert}
:::
:::
...
::: {.cell .fig-cap-location-top}
::: {.cell-output-display}
![Expectation of Electoral Fraud in Maricopa County, AZ by Recruitment Program](index_files/figure-pdf/fig-q28-likert-1.pdf){#fig-q28-likert}
:::
:::
...
::: {.cell-output-display}
![Impact on Confidence in Election Fairness and Accuracy by Recruitment Program](index_files/figure-pdf/fig-q41-likert-1.pdf){#fig-q41-likert}
:::
:::
...
::: {.cell .column-page-right}
::: {.cell-output-display}
![](index_files/figure-pdf/fig-q43-likert-1.pdf){#fig-q43-likert}
:::
:::
...
::: {#tbl-demog .cell .column-page tbl-cap='Survey sample characteristics by treatment condition'}
